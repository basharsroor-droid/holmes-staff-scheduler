...
const faq = [
  ...
  {
    q: "סידור שבועי או חודשי משנה את המחיר?",
    a: "לא. אפשר להכין סידור שבועי, דו־שבועי, חודשי או לתקופה מותאמת אישית באותו מחיר. התמחור נקבע לפי גודל העסק והיכולות במסלול."
  },
  {

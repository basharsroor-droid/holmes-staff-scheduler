...
const faq = [
  ...
  {
    q: "איך בנוי הסידור?",
    a: "הסידור נבנה לפי חודש עבודה: פותחים חודש, העובדים מגישים זמינות, ובונים ומפרסמים סידור לכל החודש. המחיר נקבע לפי גודל העסק והיכולות במסלול."
  },
  {
  ...
  {
    q: "מה זה מבצע ההשקה?",
    a: "כל עסק שפותח סביבת עבודה עד 31 בדצמבר 2026 מקבל 25% הנחה על שלושת חודשי החיוב הראשונים, בחיוב חודשי, בכל אחד מהמסלולים בתשלום. ההנחה מיושמת אוטומטית מרגע תחילת החיוב, בתום תקופת הניסיון. המחיר לאחר שלושת החודשים הוא מחיר המחירון."
  }
];
  ...
  return <main className="marketing-site pricing-page" dir="rtl">
    ...
    <section className="pro-section pricing-section" id="plans">
      <ScrollReveal className="pricing-section-heading">
        ...
        <p>כל המסלולים כוללים את כל תהליך הסידור החודשי — המחיר נקבע לפי כמות העובדים, המחלקות והמנהלים</p>
      </ScrollReveal>
      <PricingPlans />
    </section>

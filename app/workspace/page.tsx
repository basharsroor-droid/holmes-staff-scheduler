  ...
  return (
    <main className="workspace-home" dir="rtl">
      ...
      <section className="workspace-welcome">
        <div>
          <TrialBanner organizationId={membership.organization_id} />
        ...
        <>
          <section className="workspace-stats">
            <article>
              <Building2 />
              <span>
                <strong>{branchResult.data?.name ?? "הסניף"}</strong>
                <small>סביבת העבודה שלך</small>
              </span>
            </article>
            <article>
              <CalendarCheck />
              <span>
                <strong>{openPeriodsResult.count ?? 0}</strong>
                <small>חודשים פתוחים להגשה</small>
              </span>
            </article>
            <article>
              <Clock3 />
              <span>
                <strong>{templatesResult.count ?? 0}</strong>
                <small>סוגי משמרות פעילים</small>
              </span>
            </article>
          </section>
          <section className="workspace-next">
            <div>
              <p className="eyebrow">פעולות עובד</p>
              <h2>המשימות שלך</h2>
            </div>
            <div className="workspace-actions">
              <Link href="/workspace/availability">
                <CalendarCheck />
                <span>
        ...
        <>
          <section className="workspace-stats">
            <article>
              <Building2 />
              <span>
                <strong>{branchResult.data?.name ?? "הסניף הראשי"}</strong>
                <small>סניף פעיל</small>
              </span>
            </article>
            <article>
              <Users />
              <span>
                <strong>{membersResult.count ?? 0}</strong>
                <small>חברי צוות פעילים</small>
              </span>
            </article>
            <article>
              <Clock3 />
              <span>
                <strong>{templatesResult.count ?? 0}</strong>
                <small>סוגי משמרות</small>
              </span>
            </article>
          </section>

          {completedPilotSteps < pilotSteps.length ? (
            <section className="pilot-readiness" aria-labelledby="pilot-readiness-title">
              <div className="pilot-readiness-head">
                ...
                <div className="pilot-progress" aria-label={`${pilotProgress}% הושלמו`}>
                  ...
                  <small>
                    {completedPilotSteps} מתוך {pilotSteps.length}
                  </small>
                </div>
              </div>
              <div className="pilot-progress-track" aria-hidden="true">
                <span style={{ width: `${pilotProgress}%` }} />
              </div>
              <div className="pilot-checklist">
                {pilotSteps.map((step, index) => (
                  <Link className={step.complete ? "complete" : ""} href={step.href} key={step.href}>
            ...
            <section className="pilot-readiness pilot-ready">
              <div>
          ...
          <section className="workspace-next workspace-next-compact">
            ...
            <div className="workspace-actions">
              ...
              <Link href="/workspace/pilot-launch">
                <Rocket />
                <span>
          ...
          <section className="workspace-next workspace-next-compact">
            <div>
              <p className="eyebrow">מבנה ארגוני</p>
              <h2>סניפים ומחלקות</h2>
            </div>
            <div className="workspace-actions">
              <Link href="/workspace/departments">
                <Network />
                <span>
          ...
          <section className="workspace-next workspace-next-primary">
            <div>
              <p className="eyebrow">הגדרת העסק</p>
              <h2>כלי הניהול</h2>
            </div>
            <div className="workspace-actions">
              ...
              <Link href="/workspace/shift-templates">
                <Settings />
                <span>
              ...
              <Link href="/workspace/work-months">
                <CalendarDays />
                <span>

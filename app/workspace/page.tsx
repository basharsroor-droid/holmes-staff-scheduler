...
import { Building2, CalendarCheck, CalendarDays, CalendarRange, CheckCircle2, Circle, ClipboardCheck, Clock3, History, Repeat2, Settings, Users } from "lucide-react";
...
export default async function WorkspacePage() {
  ...
  const [organizationResult, branchResult, membersResult, templatesResult, periodsResult, openPeriodsResult] = await Promise.all([

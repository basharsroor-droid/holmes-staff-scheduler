    ...
    <main className="workspace-home" dir="rtl">
      <header className="workspace-subheader">
        <div>
          ...
          <p>מאשרים חופשות, יוצרים משמרות, משבצים לפי הזמינות ומפרסמים לצוות</p>
        </div>
      </header>
            ...
            {pilotMode && (
              <section className="template-list-card">
                <EmptyState
                  ...
                  description="כדי לשמור על מחזור סידור פשוט וברור, הכלים החכמים (ציון בריאות, הוגנות, טיוטה חכמה, תיקון סידור, החלפה חכמה ומשמרות פתוחות) מוסתרים בשלב זה, וייפתחו בהדרגה אחרי מחזור ראשון נקי"
                />
              </section>
            )}
            {!pilotMode && (

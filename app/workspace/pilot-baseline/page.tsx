  ...
  return (
    <main className="workspace-home" dir="rtl">
      <header className="workspace-subheader">
        <div>
          <Link href="/workspace/pilot-launch" className="back-link">
            <ArrowRight size={17} /> חזרה למרכז השקת הפיילוט
          </Link>
          <p className="eyebrow">{organization.name} · פיילוט ראשון</p>
          <h1>
            <Timer /> מדידת Baseline
          </h1>
          <p>
            לפני שאפשר להגיד &quot;ShiftPilot חסך זמן&quot;, צריך מספר להשוות אליו. שתי מדידות קצרות — לפני המחזור
            הראשון ואחרי שהוא נסגר — נשמרות כפנייה במרכז התמיכה כדי שנוכל לעקוב אחריהן.
          </p>
        </div>
      </header>

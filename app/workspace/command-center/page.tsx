...
export default async function ManagerCommandCenterPage() {
  ...
  const actions = [
    understaffed > 0 ? { href: "/workspace/schedule-builder", label: `לטפל ב-${understaffed} משמרות עם כיסוי חסר`, detail: "פתחו את בדיקת הקונפליקטים או את כלי תיקון הסידור וקבלו תוכנית תיקון מוסברת לפני ביצוע שינוי.", priority: "critical" } : null,
    pendingMarketplace > 0 ? { href: "/workspace/open-shifts", label: `להכריע ב-${pendingMarketplace} בקשות למשמרות פתוחות`, detail: "בדקו את הזכאות המעודכנת לפני אישור. ההחלטה נשארת אצל המנהל.", priority: "warning" } : null,

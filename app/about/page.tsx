    ...
    <main className="legal-page" dir="rtl">
      ...
      <article className="legal-document">
        ...
        <section>
          ...
          <p>
            המערכת שמרכזת את כל התהליך של סידור עבודה במקום אחד: הגשת זמינות
            מהעובד, בניית ופרסום הסידור אצל המנהל, ובקשות החלפה בין השניים.
            בלי גיליונות אקסל, בלי קבוצת וואטסאפ נפרדת, ובעברית מההתחלה.
          </p>
        </section>
        <section>
          <h2>למי זה מיועד</h2>
          <p>
            ...
            רמות ניהול. כל עסק מבודד לגמרי במערכת: אין דרך שעובד או מנהל
            בעסק אחד יראה נתונים של עסק אחר.
          </p>
        </section>
        <section>
          <h2>איך זה נבנה</h2>
          <p>
            ...
            אמיתי מול עסק אמיתי, לא רק תרחישי בדיקה תיאורטיים.
          </p>
        </section>
        <section>
          <h2>מה חשוב לנו</h2>

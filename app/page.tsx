...
const setupSteps = [
  ...
  { n: "03", title: "הזמנת הצוות", text: "שולחים לכל עובד הזמנה מאובטחת במייל, וכל משתמש נכנס ישירות לסביבה ולתפקיד המתאימים לו" },
...
export default function HomePage() {
  return <main className="marketing-site" dir="rtl">
    ...
    <section className="pro-section example-section" id="example">
      <ScrollReveal className="section-heading centered"><p className="pro-kicker dark">סידור שמתאים לאופן העבודה שלכם</p><h2>פתיחה, אמצע או סגירה — אתם מגדירים</h2><p>לכל סוג משמרת מגדירים שעות, מספר עובדים ודרישות מיוחדות — וזו רק דוגמה, כל עסק מתאים את המבנה לצרכים שלו</p></ScrollReveal>

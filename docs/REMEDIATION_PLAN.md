...
| 2 | **D3** schema validation אמיתית | ✅ | #248 | CI בונה מסד מאפס; זהה לפרודקשן (30/61/81/67) |
...
| — | באנר ניסיון שפג | ✅ | #259 | |
| 4 | **J1/J2** סליקה + ניהול מנוי | ⏸️ נדחה | — | בחירת ספק — החלטת בעלים בהמשך; Vercel Pro לפני הלקוח המשלם הראשון |

**מה חוסם כרגע:** Waves 0–3 סגורים. Wave 4 (הכנסה) ממתין להחלטת הבעלים על ספק הסליקה (J1).

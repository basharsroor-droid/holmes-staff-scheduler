...
| 4 | **I1** אשף הקמה | 🟡 חלקי | #263, #276 | אירועי פאנל + view `private.setup_funnel`; תבניות משמרות לפי סוג עסק (מסעדה / בית קפה / מכון כושר / חנות) בלחיצה אחת, נבדק ב-D1; נותרה הדרכה בתוך כל צעד |

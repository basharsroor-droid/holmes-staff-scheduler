...
8. ניווט לעזרה/תמיכה; בדמו מוצגים פתרונות נפוצים וקישור ישיר לצוות התמיכה, וב-SaaS נפתחת פנייה מלאה.

**קריטריון סגירה:** המסלול הזה מצליח 3 פעמים רצופות, אפס תקלת P0/P1 פתוחה, לפני שמראים למישהו את הדמו. רץ בהצלחה לפחות פעם אחת מקצה לקצה תוך כדי הפיתוח (שלב 2 ב[מפת הדרך](https://claude.ai/code/artifact/9a06ea37-4836-45e8-870a-dfbab53bfdc3), עם 5 באגים אמיתיים שנתפסו ותוקנו בדרך). **עדכון 18.8.2026:** בוצעה גם ריצה ידנית חיה נוספת דרך דפדפן אמיתי מול הפרודקשן החי (שלבים 3–7) — אפס תקלה נמצאה. **עדכון 21.8.2026:** שלב 8 נוסף לדמו ב-`/demo/help` עם פתרונות נפוצים וקישור תמיכה, ונוסף לו E2E לשני התפקידים. המסלול כולו מכוסה כעת בכל CI.
...
- [x] "3 הצלחות רצופות": מתקיים באופן רציף — `demo-workflows.spec.ts` מריץ את המסלול בכל push, כולל עזרה/תמיכה לשני תפקידי הדמו. נוספה גם ריצה ידנית-חיה ב-18.8.2026.
